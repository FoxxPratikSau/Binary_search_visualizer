...
async function BinarySearch(delay = 300) { // Asynchronous BinarySearch function
var blocks = document.querySelectorAll(".block");
var output = document.getElementById("text");


var num = document.getElementById("fname").value; //Extracting the value of the element to be searched

for (var i = 0; i < blocks.length; i += 1) { //Colouring all the blocks violet
